...
\begin{abstract}
  ...
  That's why we have devoloped an application using prompts to LLMs for the sentiment análisis and classification of user's reviews.
  
  We use this pretrained models knowlegde to design and develope an agile solution to this problem.
