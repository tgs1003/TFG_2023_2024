...
Algunos de los principios y prácticas clave de \textbf{DevOps} incluyen:
\begin{itemize}
...
Para el publicar del código de este trabajo se ha utilizado \href{https://www.docker.com/}{Docker} junto con \href{https://www.portainer.io/}{Portainer} para el 
despliegue continuo.
