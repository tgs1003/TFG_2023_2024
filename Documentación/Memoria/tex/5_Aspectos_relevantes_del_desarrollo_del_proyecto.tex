...
\begin{figure}[h]
   \advance\leftskip2cm 
   \includegraphics[scale=0.6]{svg/vader_confusion.png}
   \caption{Precisión y recall}
\end{figure}

\begin{figure}[h]
   \advance\leftskip2cm 
   \includegraphics[scale=0.6]{vader_results.png}
   \caption{Precisión y recall}
\end{figure}
\newpage
...
\begin{figure}[h]
   \advance\leftskip2cm 
   \includegraphics[scale=0.6]{svg/prompt_sentiment_confusion.png}
   \caption{Precisión y recall}
\end{figure}
...
\begin{figure}[h]
   \advance\leftskip2cm 
   \includegraphics[scale=0.6]{prompt_sentiment_results.png}
   \caption{Precisión y recall}
\end{figure}
